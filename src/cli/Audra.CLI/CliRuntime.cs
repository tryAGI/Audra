...
{
    private const string UserSecretsId = "Audra.CLI";
    private const string UserSecretApiKeyName = "AUDRA_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"AUDRA_API_KEY"];
    private const string CredentialFileDirectoryName = ".audra";

    public static async global::System.Threading.Tasks.Task<global::Audra.AudraClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Audra.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Audra.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Audra.AudraClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Audra.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Audra.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Audra.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Audra.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("AUDRA_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Audra.ApiException exception)
    {
        var builder = new StringBuilder();
