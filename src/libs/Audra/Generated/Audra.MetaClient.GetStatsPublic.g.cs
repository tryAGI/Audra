...
namespace Audra
{
    public partial class MetaClient
    {
        ...
        private static readonly global::Audra.AutoSDKServer[] s_GetStatsPublicServers = new global::Audra.AutoSDKServer[]
        ...
        private static readonly global::Audra.EndPointSecurityRequirement s_GetStatsPublicSecurityRequirement0 =
        ...
        private static readonly global::Audra.EndPointSecurityRequirement[] s_GetStatsPublicSecurityRequirements =
            new global::Audra.EndPointSecurityRequirement[]
            {                s_GetStatsPublicSecurityRequirement0,
            };
        partial void PrepareGetStatsPublicArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareGetStatsPublicRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessGetStatsPublicResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetStatsPublicResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audra.PublicStats> GetStatsPublicAsync(
            global::Audra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetStatsPublicAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audra.AutoSDKHttpResponse<global::Audra.PublicStats>> GetStatsPublicAsResponseAsync(
            global::Audra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetStatsPublicArguments(
                httpClient: HttpClient);


            var __authorizations = global::Audra.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetStatsPublicSecurityRequirements,
                operationName: "GetStatsPublicAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Audra.PathBuilder(
                                path: "/v2/stats/public",
                                baseUri: ResolveBaseUri(
                                servers: s_GetStatsPublicServers,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetStatsPublicAsync",
                                pathTemplate: "\"/v2/stats/public\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Audra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetStatsPublicResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audra.PublicStats.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audra.AutoSDKHttpResponse<global::Audra.PublicStats>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audra.PublicStats.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
