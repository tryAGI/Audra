...
namespace Audra
{
    public partial class AuthClient
    {
        ...
        private static readonly global::Audra.AutoSDKServer[] s_CreateAccountsKeyRecoveryConfirmServers = new global::Audra.AutoSDKServer[]
        ...
        private static readonly global::Audra.EndPointSecurityRequirement s_CreateAccountsKeyRecoveryConfirmSecurityRequirement0 =
        ...
        private static readonly global::Audra.EndPointSecurityRequirement[] s_CreateAccountsKeyRecoveryConfirmSecurityRequirements =
            new global::Audra.EndPointSecurityRequirement[]
            {                s_CreateAccountsKeyRecoveryConfirmSecurityRequirement0,
            };
        partial void PrepareCreateAccountsKeyRecoveryConfirmArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Audra.CreateAccountsKeyRecoveryConfirmRequest request);
        partial void PrepareCreateAccountsKeyRecoveryConfirmRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Audra.CreateAccountsKeyRecoveryConfirmRequest request);
        partial void ProcessCreateAccountsKeyRecoveryConfirmResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task CreateAccountsKeyRecoveryConfirmAsync(

            global::Audra.CreateAccountsKeyRecoveryConfirmRequest request,
            global::Audra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await CreateAccountsKeyRecoveryConfirmAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audra.AutoSDKHttpResponse> CreateAccountsKeyRecoveryConfirmAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateAccountsKeyRecoveryConfirmArguments(
            ...
            var __authorizations = global::Audra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateAccountsKeyRecoveryConfirmSecurityRequirements,
                operationName: "CreateAccountsKeyRecoveryConfirmAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Audra.PathBuilder(
                                path: "/v2/accounts/key-recovery/confirm",
                                baseUri: ResolveBaseUri(
                                servers: s_CreateAccountsKeyRecoveryConfirmServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateAccountsKeyRecoveryConfirmRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createAccountsKeyRecoveryConfirm",
                                methodName: "CreateAccountsKeyRecoveryConfirmAsync",
                                pathTemplate: "\"/v2/accounts/key-recovery/confirm\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateAccountsKeyRecoveryConfirmResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task CreateAccountsKeyRecoveryConfirmAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Audra.CreateAccountsKeyRecoveryConfirmRequest
            {
                Token = token,
            };

            await CreateAccountsKeyRecoveryConfirmAsync(
                request: __request,
                requestOptions: requestOptions,
