    ...
    public static class BatchSpeechRequestDeliveryProfileExtensions
    {
        ...
        public static string ToValueString(this BatchSpeechRequestDeliveryProfile value)
        {
            return value switch
            {
                ...
                BatchSpeechRequestDeliveryProfile.PodcastV3 => "podcast_v3",
                BatchSpeechRequestDeliveryProfile.PodcastV4 => "podcast_v4",
        ...
        public static BatchSpeechRequestDeliveryProfile? ToEnum(string value)
        {
            return value switch
            {
                ...
                "podcast_v3" => BatchSpeechRequestDeliveryProfile.PodcastV3,
                "podcast_v4" => BatchSpeechRequestDeliveryProfile.PodcastV4,
                _ => null,
            };
        }
    }
