...
namespace Audra
{
    public partial class BillingClient
    {
        ...
        private static readonly global::Audra.AutoSDKServer[] s_CreateBillingCheckoutServers = new global::Audra.AutoSDKServer[]
        ...
        private static readonly global::Audra.EndPointSecurityRequirement s_CreateBillingCheckoutSecurityRequirement0 =
        ...
        private static readonly global::Audra.EndPointSecurityRequirement[] s_CreateBillingCheckoutSecurityRequirements =
            new global::Audra.EndPointSecurityRequirement[]
            {                s_CreateBillingCheckoutSecurityRequirement0,
            };
        partial void PrepareCreateBillingCheckoutArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Audra.CreateBillingCheckoutRequest request);
        partial void PrepareCreateBillingCheckoutRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Audra.CreateBillingCheckoutRequest request);
        partial void ProcessCreateBillingCheckoutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateBillingCheckoutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audra.CreateBillingCheckoutResponse> CreateBillingCheckoutAsync(

            global::Audra.CreateBillingCheckoutRequest request,
            global::Audra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateBillingCheckoutAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audra.AutoSDKHttpResponse<global::Audra.CreateBillingCheckoutResponse>> CreateBillingCheckoutAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateBillingCheckoutArguments(
            ...
            var __authorizations = global::Audra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateBillingCheckoutSecurityRequirements,
                operationName: "CreateBillingCheckoutAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Audra.PathBuilder(
                                ...
                                servers: s_CreateBillingCheckoutServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateBillingCheckoutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateBillingCheckoutAsync",
                                pathTemplate: "\"/v2/billing/checkout\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateBillingCheckoutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audra.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateBillingCheckoutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audra.CreateBillingCheckoutResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audra.AutoSDKHttpResponse<global::Audra.CreateBillingCheckoutResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audra.CreateBillingCheckoutResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Audra.CreateBillingCheckoutResponse> CreateBillingCheckoutAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Audra.CreateBillingCheckoutRequest
            {
                Pack = pack,
            };

            return await CreateBillingCheckoutAsync(
                request: __request,
                requestOptions: requestOptions,
