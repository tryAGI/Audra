...
namespace Audra
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Audra.AutoSDKRetryOptions Retry { get; set; } = new global::Audra.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Audra.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Audra.IAutoSDKHook>();
        ...
        public global::Audra.AutoSDKClientOptions AddHook(
            global::Audra.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Audra.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Audra.AutoSDKClientOptions UseAuthorizationProvider(
            global::Audra.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Audra.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Audra.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Audra.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Audra.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Audra.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Audra.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Audra.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Audra.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Audra.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Audra.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Audra.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Audra.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Audra.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Audra.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Audra.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Audra.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Audra.AutoSDKClientOptions clientOptions,
            global::Audra.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Audra.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Audra.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Audra.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Audra.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Audra.IAutoSDKHook, global::Audra.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Audra.AutoSDKHookContext context)
        {
