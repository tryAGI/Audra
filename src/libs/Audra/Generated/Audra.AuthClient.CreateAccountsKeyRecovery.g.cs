...
namespace Audra
{
    public partial class AuthClient
    {
        ...
        private static readonly global::Audra.AutoSDKServer[] s_CreateAccountsKeyRecoveryServers = new global::Audra.AutoSDKServer[]
        ...
        private static readonly global::Audra.EndPointSecurityRequirement s_CreateAccountsKeyRecoverySecurityRequirement0 =
        ...
        private static readonly global::Audra.EndPointSecurityRequirement[] s_CreateAccountsKeyRecoverySecurityRequirements =
            new global::Audra.EndPointSecurityRequirement[]
            {                s_CreateAccountsKeyRecoverySecurityRequirement0,
            };
        partial void PrepareCreateAccountsKeyRecoveryArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Audra.CreateAccountsKeyRecoveryRequest request);
        partial void PrepareCreateAccountsKeyRecoveryRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Audra.CreateAccountsKeyRecoveryRequest request);
        partial void ProcessCreateAccountsKeyRecoveryResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task CreateAccountsKeyRecoveryAsync(

            global::Audra.CreateAccountsKeyRecoveryRequest request,
            global::Audra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await CreateAccountsKeyRecoveryAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audra.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audra.AutoSDKHttpResponse> CreateAccountsKeyRecoveryAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateAccountsKeyRecoveryArguments(
            ...
            var __authorizations = global::Audra.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateAccountsKeyRecoverySecurityRequirements,
                operationName: "CreateAccountsKeyRecoveryAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Audra.PathBuilder(
                                path: "/v2/accounts/key-recovery",
                                baseUri: ResolveBaseUri(
                                servers: s_CreateAccountsKeyRecoveryServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateAccountsKeyRecoveryRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audra.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audra.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createAccountsKeyRecovery",
                                methodName: "CreateAccountsKeyRecoveryAsync",
                                pathTemplate: "\"/v2/accounts/key-recovery\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateAccountsKeyRecoveryResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task CreateAccountsKeyRecoveryAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Audra.CreateAccountsKeyRecoveryRequest
            {
                Email = email,
            };

            await CreateAccountsKeyRecoveryAsync(
                request: __request,
                requestOptions: requestOptions,
