...
The Audra SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Audra
```
...
using var client = new AudraClient(
    apiKey: Environment.GetEnvironmentVariable("AUDRA_API_KEY")!);
