<div class="docs-hero">
  <h1>Audra</h1>
  <p class="docs-hero-lead">Modern .NET SDK for Audra generated from the provider's OpenAPI definition with AutoSDK.</p>
  <div class="docs-badge-row">
    <a href="https://www.nuget.org/packages/Audra/"><img alt="Nuget package" src="https://img.shields.io/nuget/vpre/Audra"></a>
    <a href="https://github.com/tryAGI/Audra/actions/workflows/dotnet.yml"><img alt="dotnet" src="https://github.com/tryAGI/Audra/actions/workflows/dotnet.yml/badge.svg?branch=main"></a>
    <a href="https://github.com/tryAGI/Audra/blob/main/LICENSE"><img alt="License: MIT" src="https://img.shields.io/github/license/tryAGI/Audra"></a>
...
<div class="docs-feature-grid">
  <div class="docs-feature-card">
    ...
    <p>Built from <a href="https://audratalks.com/openapi.yaml">Audra's OpenAPI definition</a> so the SDK stays close to the upstream API surface.</p>
  </div>
  <div class="docs-feature-card">
    <h3>Auto-updated</h3>
...
<div class="docs-card-grid">
  <div class="docs-card">
    <h3>Bugs</h3>
    <p>Open an issue in <a href="https://github.com/tryAGI/Audra/issues">tryAGI/Audra</a>.</p>
  </div>
  <div class="docs-card">
    <h3>Ideas and questions</h3>
    <p>Use <a href="https://github.com/tryAGI/Audra/discussions">GitHub Discussions</a> for design questions and usage help.</p>
  </div>
  <div class="docs-card">
    <h3>Community</h3>
